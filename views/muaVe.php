...
<body>
    ...
    <main class="noidung muaveMain">
        <h2 class="vip vanban">Các loại vé</h2>
        <div class="cac-ve">
            <div class="thong-tin-muave">
                <h3 class="ten-ve vanban-muave">VÉ TUẦN ( 02+03/11)</h3>
                <p class="gia-ve vanban-muave">
                    <span class="so-gia">100.000</span>
                    <span class="don-vi">VND</span>
                </p>
                <div class="mota">
                    <p>VÉ THỨ BẢY</p>
                    <p>VÉ CHỦ NHẬT</p>
                </div>
                <button class="mua--ve">MUA VÉ</button>
            </div>
            <div class="thong-tin-muave">
                <h3 class="ten-ve vanban-muave">VÉ THỨ BẢY (02/11)</h3>
                <p class="gia-ve vanban-muave">
                    <span class="so-gia">600K</span>
                    <span class="don-vi">VND</span>
                </p>
                <div class="mota">
                    <p>VÉ THỨ BẢY</p>
            ...
            <div class="thong-tin-muave">
                <h3 class="ten-ve vanban-muave">VÉ CHỦ NHẬT (03/11)</h3>
                <p class="gia-ve vanban-muave">
                    <span class="so-gia">300K</span>
                    <span class="don-vi">VND</span>
                </p>
                <div class="mota">
                    <p>VÉ CHỦ NHẬT</p>
            ...
            <div class="thong-tin-muave">
                <h3 class="ten-ve vanban-muave">VÉ VIP (02-03/11)</h3>
                <p class="gia-ve vanban-muave">
                    <span class="so-gia">5,000K</span>
                    <span class="don-vi">VND</span>
                </p>
                <div class="mota">
                    <p>VÉ CẢ HAI NGÀY 2-3</p>
                    <p>LẦN ƯU TIÊN</p>
                    <p>THAM GIA SỚM (2 GIỜ)</p>
                    <p>QUÀ GIỚI HẠN - HOBBY BOX</p>
                </div>
                <button class="mua--ve">MUA VÉ</button>
            </div>
            ...
            <div class="lienhe">
                <div class="mang-xa-hoi" style="user-select: none;">
                    ...
                    <a href="https://www.instagram.com/hobbyhorizonvn/" target="_blank"><img
                            src="<?php echo BASE_URL; ?>/public/images/Icon/instagram-167-svgrepo-com.svg" alt="Instagram"
                            style="width:3.4rem;height:auto"></a>
                    <a href="https://www.youtube.com/channel/UC9J6J9ZQ1J1jJ6Z9Zv9J9JQ" target="_blank"><img
                            src="<?php echo BASE_URL; ?>/public/images/Icon/X.jpg" alt="Youtube" style="width:3.4rem;height:auto"></a>
                </div>
