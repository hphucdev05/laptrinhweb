...
<body>
    <div id="wrapper">
    <form action="<?php echo BASE_URL; ?>/index.php?page=register" method="POST" id="form-login" style="  height: 580px;">
            <div class="head">
            ...
            <div class="form-login-detail">
                <div class="form-group dangky ">
                    ...
                    <input type="text" id="username" name="username" class="input-field" placeholder="Nhập họ và tên">
                </div>
                <div class="form-group dangky">
                    <label for="Email">Email</label>
                    <input type="Email" id="Email" name="email" class="input-field" placeholder="Nhập Email">
                </div>
                <div class="form-group dangky">
                    <label for="password">Mật khẩu</label>
                    <input type="password" id="password" name="password" class="input-field"
                        placeholder="Nhập mật khẩu">
                    <span class="password-requirements">Mật khẩu phải có ít nhất 8 ký tự, bao gồm chữ hoa, chữ thường,
                        số và ký tự đặc biệt</span>
                </div>
                <div class="form-group dangky">
                ...
                <div class="dang-ky vanban" style="padding-top:14px">
                    <span>Đã có tài khoản?</span>
                    <br>
                    <a href="<?php echo BASE_URL; ?>/views/dangNhap.php">Đăng nhập</a>
                </div>
